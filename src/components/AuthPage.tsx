...
import { Mail, Lock, User, Eye, EyeOff, Code2, Trophy, Target, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Solve problems across multiple programming languages"
    },
    {
      icon: <Trophy className="w-6 h-6 text-yellow-500" />,
      title: "Track Progress",
      description: "Monitor your solving streak and improvement over time"
    },
    {
      icon: <Target className="w-6 h-6 text-green-500" />,
      title: "Targeted Learning",
      description: "Focus on specific DSA topics and algorithms"
    },
    {
      icon: <Zap className="w-6 h-6 text-purple-500" />,
      title: "Real-time Testing",
      description: "Run and test your code instantly with comprehensive test cases"
    }
  ];
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700 p-12 flex-col justify-center">
        <div className="max-w-md">
          ...
          <p className="text-blue-100 text-lg mb-12 leading-relaxed">
            Join thousands of developers improving their coding skills with our comprehensive platform.
          </p>
